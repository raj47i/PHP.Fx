 ...
 */
    ...
    {
        $this->_fetch($resource_name, $cache_id, $compile_id, true);
    }
     ...
     */
    function _fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        if ($params['resource_type'] == 'file') {
            if (!preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $params['resource_name'])) {
                ...
                foreach ((array)$params['resource_base_path'] as $_curr_path) {
                    $_fullpath = $_curr_path . '/' . $params['resource_name'];
